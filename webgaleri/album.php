                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="hapus_album.php?albumid=<?= $data['albumid'] ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus foto ini?')">Hapus</a>
